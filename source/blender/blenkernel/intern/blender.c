...
char upbge_legacy_versionstr[48] = "";
...
void BKE_upbge_legacy_version_string(char *version_str, size_t maxncpy, short major, short minor, short patch)
{
	BLI_snprintf(version_str, maxncpy, "v%d.%d.%d", major, minor, patch);
}
...
void BKE_blender_globals_init(void)
{
	...
	BKE_upbge_legacy_version_string(upbge_legacy_versionstr, sizeof(versionstr), UPBGE_LEGACY_MAJOR, UPBGE_LEGACY_MINOR, UPBGE_LEGACY_PATCH);
